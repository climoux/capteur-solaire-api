...
CREATE TABLE devices (
    device_id VARCHAR(64) PRIMARY KEY UNIQUE,   -- identifiant unique du capteur
...
CREATE TABLE device_state (
    device_id VARCHAR(64) PRIMARY KEY UNIQUE REFERENCES devices(device_id) ON DELETE CASCADE,
